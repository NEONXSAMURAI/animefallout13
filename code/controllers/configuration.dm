...
/datum/configuration
	...
	var/server
	var/banappeals
	var/wikiurl = "https://discord.gg/fMzbRHG" // default wiki
	var/forumurl = "https://discord.gg/fMzbRHG" //default forums
	var/rulesurl = "https://discord.gg/fMzbRHG" // default rules
	var/discord = "https://discord.gg/fMzbRHG" //default chat
	var/bitbucket = "https://discord.gg/fMzbRHG" //default code
	...
	var/alert_desc_delta = "Destruction of the Vault is imminent. All dwellers are instructed to obey all instructions given by overseer. Any violations of these orders can be punished by death. This is not a drill."
